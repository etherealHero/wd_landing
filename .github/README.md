...
Этот репозиторий содержит адаптивную верстку лендинговой страницы для сайта портфолио. [**Онлайн просмотр**][preview]
...
[license]: /LICENSE
[preview]: https://etherealhero.github.io/wd_landing/
